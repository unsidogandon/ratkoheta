...
class FancyClockMod(loader.Module):
    ...
    async def _loop(self):
        while self._running:
            try:
                ...
                fancy_time = _fancy(now.strftime("%H:%M"), self._font)
    ...
    async def fcscmd(self, message: Message):
        ...
        try:
            async with aiohttp.ClientSession() as session:
                ...
                preview = _fancy(now.strftime("%H:%M"), self._font)
    ...
    async def fcfcmd(self, message: Message):
        ...
        current_preview = _fancy(now_str, self._font)
    ...
    async def _pick_font(self, call, chars: str, label: str):
        ...
        preview = _fancy(now.strftime("%H:%M"), chars)
